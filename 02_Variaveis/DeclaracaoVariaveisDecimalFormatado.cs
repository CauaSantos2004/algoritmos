...
class DeclaracaovariaveisDecimalFormatado
{
	static void Main(string[] args)
	{
		...
		*/
		...
		/*
		Interpolação de Sting, só funciona no .Net versão 6.0 acima
		*/
		/*
		Console.WriteLine($"Minha quantia - {0:C}");
		Console.WriteLine($"Sua quantia - {0:C}");
		Console.WriteLine($"Valor de x = {0: F3} e Valor de y = {y:C}");
		*/
	}
}